...
const urlReportSchema: Schema<UrlReportDocument, UrlReportModel> = new mongoose.Schema(
  {
...
const UrlReportModel = mongoose.model<UrlReportDocument, UrlReportModel>('UrlReport', urlReportSchema);
